...
with open('week03_train.csv', mode='w', newline='') as train_file:
    ...
    for objTrainPositionsNode in objTrainPositionsNodes:
        ...
        for retrieveTag in retrieveTags:
            ...
            test = objTrainPositionsNode.getElementsByTagName("TrainCode").item(0)
            traincodetest = test.firstChild.nodeValue.strip()
            #print("test: ", traincodetest)

            if traincodetest[0] == "D":
